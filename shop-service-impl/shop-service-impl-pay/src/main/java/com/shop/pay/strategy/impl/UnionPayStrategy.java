...
public class UnionPayStrategy implements PayStrategy {
  ...
  public String toPayHtml(PaymentChannelEntity paymentChannel, PaymentTransactionDTO paymentTransaction) {
	...
	requestData.put("txnTime", format(paymentTransaction.getCreatedTime())); // 订单发送时间，取系统时间，格式为YYYYMMDDhhmmss，必须取当前时间，否则会报txnTime无效
	requestData.put("currencyCode", "156"); // 交易币种（境内商户一般是156 人民币）
	Long payAmount = paymentTransaction.getPayAmount();
